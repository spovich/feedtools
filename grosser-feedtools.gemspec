...
Gem::Specification.new do |s|
  s.name = %q{grosser-feedtools}
  s.version = "0.2.29"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Bob Aman"]
  s.date = %q{2011-05-05}
  s.description = %q{Implements a simple system for handling xml news feeds with caching.}
  ...
  s.homepage = %q{http://github.com/grosser/feedtools}
  ...
  s.summary = %q{Parsing, generation, and caching system for xml news feeds.}
